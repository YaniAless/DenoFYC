...
client.connectWithUri('mongodb+srv://KalyDeno:xwwjoo5ir7Ek3co4@cluster0.vm5ok.mongodb.net/testApp?retryWrites=true&w=majority');
...
router.post('/addPokemon', async (ctx) => {
